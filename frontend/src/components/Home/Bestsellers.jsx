      ...
      <div className="sec-head">
        ...
        {total > 1 && (
          <div className="sec-nav">
            ...
            <button type="button" className="arr-btn" onClick={(e) => { e.currentTarget.blur(); setPage((p) => p - 1); }} disabled={page === 0} aria-label="Previous page"><ChevronLeft /></button>
            <button type="button" className="arr-btn" onClick={(e) => { e.currentTarget.blur(); setPage((p) => p + 1); }} disabled={page === total - 1} aria-label="Next page"><ChevronRight /></button>
          </div>
        )}
      </div>
